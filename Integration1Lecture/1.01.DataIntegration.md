...
You might have heard of a [data silo](http://searchcloudapplications.techtarget.com/definition/data-silo/) – a fixed repository of information. Like a farm silo, its contents are isolated from the outside world. Did you know the feed inside a farm silo is often [fermented](http://en.wikipedia.org/wiki/Silage#Fermentation)? Did you know the air and liquid emitted during fermentation is toxic? Data trapped in silos 'ferments' and becomes useless.
...
For further reading, why not browse [articles tagged with data integration](https://blog.safe.com/tag/data-integration/) on our blog?
