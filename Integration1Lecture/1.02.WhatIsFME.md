...
**FME (the Feature Manipulation Engine)** is a data translation and transformation tool for solving problems of data interoperability, without the need for coding. FME connects data between 400+ formats including GIS, CAD, database, tabular, BIM, 3D, point cloud / LiDAR, raster, XML, and cloud.
