...
![](/Integration3LabExercises/Images/Img1.214.Ex4.DisplayControlWindow.png)
...
![](/Integration3LabExercises/Images/Img1.215.Ex4.SetSymbologyIcon.png)

Set the color to be a neutral shade (like orange) and increase the opacity value to 0.8:

![](/Integration3LabExercises/Images/Img1.216.Ex4.SetSymbologyDialog.png)
...
![](/Integration3LabExercises/Images/Img1.217.Ex4.ResymbolizedData.png)
...
![](/Integration3LabExercises/Images/Img1.218.Ex4.AddTransformer.png)
...
![](/Integration3LabExercises/Images/Img1.219.Ex4.DissolverTransformer.png)
...
![](/Integration3LabExercises/Images/Img1.220.Ex4.DissolverParametersButton.png)
...
![](/Integration3LabExercises/Images/Img1.221.Ex4.DissolverGroupByParameter.png)
...
![](/Integration3LabExercises/Images/Img1.222.Ex4.DIRefreshView.png)
...
![](/Integration3LabExercises/Images/Img1.223.Ex4.BackgroundMapDialog.png)

Click the Parameters button. A map constraint (type) dialog will open. Click the browse button and select "terrain":

![](/Integration3LabExercises/Images/Img1.224.Ex4.BackgroundMapPropertiesDialog.png)
...
![](/Integration3LabExercises/Images/Img1.225.Ex4.DataWithBackgroundMap.png)
...
![](/Integration3LabExercises/Images/Img1.226.Ex4.FilterButton.png)
...
![](/Integration3LabExercises/Images/Img1.227.Ex4.OneFilterSet.png)
...
![](/Integration3LabExercises/Images/Img1.228.Ex4.TwoFiltersSet.png)

The Pass Criteria parameter should be set (or left as) "One Test (OR)".

![](/Integration3LabExercises/Images/Img1.229.Ex4.DIFilterCriteria.png)
...
![](/Integration3LabExercises/Images/Img1.230.Ex4.FilteredData.png)
<br><span style="font-style:italic;font-size:x-small">Map tiles by <a href="http://stamen.com">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0">CC-BY-3.0</a>. Data by <a href="http://openstreetmap.org">OpenStreetMap</a>, under <a href="http://creativecommons.org/licenses/by-sa/3.0">CC-BY-SA</a>.

The Display Control Window will also show the effects of the filter:

![](/Integration3LabExercises/Images/Img1.231.Ex4.DisplayControlFilter.png)
...
![](/Integration3LabExercises/Images/Img1.231a.Ex4.WriterParameters.png)

In the dialog that opens, set the Formatting Type to Linear and the Coordinate Precision to 6:

![](/Integration3LabExercises/Images/Img1.231b.Ex4.SettingWriterParameters.png)
