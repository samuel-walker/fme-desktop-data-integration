...
<br>**7) Rt-click on the Tester Failed port and choose the option Connect Logger:

![](../DesktopBasic2Transformation/Images/Img2.215.Ex2.TesterConnectLogger.png)

A Logger transformer will be added to the workspace. This will record all incoming features to the log window:

![](../DesktopBasic2Transformation/Images/Img2.216.Ex2.WorkspaceWithLogger.png)
